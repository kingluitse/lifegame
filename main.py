...
import json         # Para guardar y leer archivos en formato JSON (usuarios y personajes)
import os           # Para verificar si el archivo de usuarios existe
...
# Archivo donde se guardarán los datos de los usuarios registrados y sus personajes
...
def cargar_usuarios():
    """Carga los usuarios desde el archivo JSON si existe. Devuelve una lista."""
...
def guardar_usuarios():
    """Guarda la lista de usuarios y sus datos en el archivo JSON."""
