...
# Inicializar Firebase desde variable de entorno segura
firebase_json_str = os.getenv("FIREBASE_CREDENTIALS_JSON")
if not firebase_json_str:
    raise Exception("No se encontró la variable de entorno FIREBASE_CREDENTIALS_JSON")

with tempfile.NamedTemporaryFile(delete=False) as temp_file:
    temp_file.write(firebase_json_str.encode())
    temp_file.flush()
